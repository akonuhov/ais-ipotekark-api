<template lang="html">
  <main-layout title="Список заемщиков">
    <div class="ui-bordered px-4 pt-4 mb-4">
      <div class="form-row align-items-center">
        ...
        <div class="col-md col-xl-2 mb-4">
          <label class="form-label d-none d-md-block">&nbsp;</label>
          <b-btn variant="primary" :block="true" to="/borrowers/create">Добавить</b-btn>
        </div>
      </div>
    </div>
    <b-card no-body>
...
export default {
  ...
  data: () => ({
    ...
    fields: [
      ...
      { key: 'Место проживания', sortable: true, tdClass: 'align-middle' },
      { key: 'Рабочий телефон', sortable: true, tdClass: 'align-middle' },
